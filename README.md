...
ok    Для простоты можно зашить адрес видеофайла в JScript  
...
ok    Добавить пометку что видео записано  
okno  Добавить ограничение, что нельзя записать видео, пока не добавлена картинка  
...
no  2.3. Разместить 3 кнопки 3-х цветов  
no    При нажатии на кнопку закрашивать область соответствующим цветом  
ok  2.4. Рисование на форме с использованием Canvas  
no    При нажатии на область рисовать круг  
...
### 3. Работа с БД
    ...
    3.2. Создать в БД таблицу для хранения картинок (данных о картинках)  
    3.3. Написать php скрипт, формирующий страницу со списком картинок  
    3.4. Написать рнр скрипт, формирующий страницу картинки  
    3.5. Связать скрипты гиперссылками  
...
Поддержка контента: текст, форматированный текст, фото, видео, 3д-модели, аудиодорожки, видео  
...
### Второстепенные функции и дальнейшее развитие
